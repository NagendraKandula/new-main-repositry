...
// ----------------- ChartTooltipContent -----------------
// Removed "TooltipPayload" which is causing the errors.
// The `payload` prop from TooltipProps is already correctly typed.
...
function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    // The `payload` here is typed from Recharts.TooltipProps
    const [item] = payload;
