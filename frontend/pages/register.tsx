            ...
            {password.length > 0 && (
              <div className={styles.passwordStrengthContainer}>
                <div className={styles.strengthBarWrapper}>
                  ...
                  <span
                    className={`${styles.strengthText} ${
                      styles[
                        `strengthText-${passwordStrengthText.toLowerCase()}`
                      ]
                    }`}
                  >
                ...
                <ul className={styles.validationList}>
                  ...
                  <li
                    className={passwordValidation.hasUpper ? styles.valid : ""}
                  >
                    One uppercase letter
                  </li>
                  <li
                    className={passwordValidation.hasLower ? styles.valid : ""}
                  >
                    One lowercase letter
                  </li>
                  <li
                    className={passwordValidation.hasNumber ? styles.valid : ""}
                  >
                    One number
                  </li>
                  <li
                    className={
                      passwordValidation.hasSpecial ? styles.valid : ""
                    }
                  >
